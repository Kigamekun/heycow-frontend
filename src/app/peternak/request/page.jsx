...
export default function History() {
    ...
    console.log('Requests title:', requests.length > 0 ? requests[0].title : 'No data');
    console.log('Requests title :', requests[0] && requests[0].cattle.name );
    ...
    console.log('data',cattleData && cattleData.data && cattleData.data.breed.name)
    return (
        <>
            ...
            <div className="d-flex justify-center">
                <div className="w-[60rem] p-4 bg-white border border-gray-300 rounded-lg shadow-sm">
                    ...
                    >
                        <h3 className="text-lg font-semibold">{requests[0] && requests[0].title}</h3>
                        <span
                                    ...
                                    <div className="d-flex justify-center">
                                        ...
                                        <Table>
                                            ...
                                            <TableRow className="text-black border-b border-black">
                                                ...
                                                <TableCell className="text-sm font-thin">{cattleData && cattleData.data && cattleData.data.breed.name}</TableCell>
                                            </TableRow>
                                            <TableRow className="text-black border-b border-black">
                                                <TableCell className="text-lg font-bold">Gender</TableCell>
                                                <TableCell className="text-sm font-thin">{cattleData && cattleData.data && cattleData.data.gender}</TableCell>
                                            </TableRow>
                                            <TableRow className="text-black border-b border-black">
                                                <TableCell className="text-lg font-bold">Date of Birth</TableCell>
                                                <TableCell className="text-sm font-thin">{cattleData && cattleData.data && cattleData.data.birth_date}</TableCell>
                                            </TableRow>
                                            <TableRow className="text-black border-b border-black">
                                                <TableCell className="text-lg font-bold">Weight</TableCell>
                                                <TableCell className="text-sm font-thin">{cattleData && cattleData.data && cattleData.data.birth_weight}</TableCell>
                                            </TableRow>
                                            <TableRow className="text-black border-b border-black">
                                                <TableCell className="text-lg font-bold">Height</TableCell>
                                                <TableCell className="text-sm font-thin">{cattleData && cattleData.data && cattleData.data.birth_height}</TableCell>
                                            </TableRow>
                                            <TableRow className="text-black">
                                                <TableCell className="text-lg font-bold">IoT Devices</TableCell>
                                                <TableCell className="text-sm font-thin">{cattleData && cattleData.data && cattleData.data.iot_device.serial_number}</TableCell>
                                            </TableRow>
                                            </TableBody>
                                        </Table>
                                        </div>
                                        ...
                                        {/* <div className="border border-black rounded-lg">
                                            <Table>
                                                ...
                                                <TableRow className="text-black border-b border-black">
                                                    <TableCell className="text-lg font-bold">Breed</TableCell>
                                                    <TableCell className="text-sm font-thin">{cattleData ? cattleData.breed : 'Loading...'}</TableCell>
                                                </TableRow>
                                                <TableRow className="text-black border-b border-black">
                                                    <TableCell className="text-lg font-bold">Gender</TableCell>
                                                    <TableCell className="text-sm font-thin">{cattleData ? cattleData.gender : 'Loading...'}</TableCell>
                                                </TableRow>
                                                <TableRow className="text-black border-b border-black">
                                                    <TableCell className="text-lg font-bold">Date of Birth</TableCell>
                                                    <TableCell className="text-sm font-thin">{cattleData ? cattleData.dateOfBirth : 'Loading...'}</TableCell>
                                                </TableRow>
                                                <TableRow className="text-black border-b border-black">
                                                    <TableCell className="text-lg font-bold">Weight</TableCell>
                                                    <TableCell className="text-sm font-thin">{cattleData ? cattleData.weight : 'Loading...'}</TableCell>
                                                </TableRow>
                                                <TableRow className="text-black border-b border-black">
                                                    <TableCell className="text-lg font-bold">Height</TableCell>
                                                    <TableCell className="text-sm font-thin">{cattleData ? cattleData.height : 'Loading...'}</TableCell>
                                                </TableRow>
                                                <TableRow className="text-black">
                                                    <TableCell className="text-lg font-bold">IoT Devices</TableCell>
                                                    <TableCell className="text-sm font-thin">{cattleData ? cattleData.iotDevices : 'Loading...'}</TableCell>
                                                </TableRow>
                                                </TableBody>
                                            </Table>
                                        </div> */}
