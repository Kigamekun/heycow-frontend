...
export default function ForumPage() {
    ...
    const getForumData = async () => {
        try{
            const res = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND_HOST}/api/blog-posts?category=forum`,{
                headers :{
            ...
            if(res.data.data) {
                setForumData(res.data.data.data);
    ...
    const createBlog = async (e) => {
        ...
        bodyFormData.append('title', forum.title);
        bodyFormData.append('content', forum.content);
        bodyFormData.append('image', forum.image);
        bodyFormData.append('category', forum.category);
    ...
    const createCattle = async (e) => {
      ...
      const handleFileChange = (event) => {
          setForum({ ...forum, image: event.target.files[0] });
      };
                                    ...
                                    <div className="grid grid-cols-1 gap-3">
                                        <div className="grid grid-cols-1 gap-1">
                                            ...
                                            <Input
                                                ...
                                                autoFocus
                                                type="text"
                                                placeholder="Input your forum title"
                                                variant="bordered"
                                        ...
                                        <div className="grid grid-cols-1 gap-1">
                                            ...
                                            <Input
                                                ...
                                                autoFocus
                                                type="text"
                                                placeholder="Input your forum caption"
                                                variant="bordered"
                                                className="w-full h-[2.8rem] "
                                                onChange={handleInputChange}
                                            />
