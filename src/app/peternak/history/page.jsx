    ...
    return(
        ...
        <div className="p-4 bg-white border rounded-lg shadow-sm">
            <div className="flex items-center justify-between cursor-pointer" onClick={toggleCollapse}>
                ...
                <span className={`text-gray-500 ${isBouncing ? 'animate-bounce' : ''}`}>
                    {isCollapsed ? '+' : '-'}
                </span>
            </div>
            <p className="text-gray-600">{isCollapsed ? '1 Activity' : '1 Activity (click to hide details)'}</p>
            
            {!isCollapsed && (
                <><div className="flex items-center w-full p-2 mx-auto mb-3 bg-white rounded-lg shadow-sm float-start">
                        {/* Date Icon */}
                    ...
                    </div><div className="flex items-center w-full p-2 mx-auto bg-white rounded-lg shadow-sm float-start">
                            {/* Date Icon */}
                            <div className="flex flex-col items-center justify-center ml-2 font-semibold leading-tight text-white rounded-full w-14 h-14 bg-emerald-500">
                                <div className="text-center">
